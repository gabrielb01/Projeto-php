...
<div class="container">
    <div class="row">
        ...
        $receitas = $database->query("SELECT * FROM RECEITA WHERE id_usuario=:id", [':id' => $_SESSION['user']]);

        foreach ($receitas as $receita) :
        ?>
            <div class="col-md-3 col-sm-4 col-12">
                <div class="card" style="width: 18rem;">
                    <img class="card-img-top" src="<?= $receita['foto_receita'] ?>" height="200px" alt="Card image cap">
                    <div class="card-body">
