...
<div class="container-fluid">
    <div class="center">
        <div class="col-sm-3 col-xs-3">
            <form class="form-autenticao form" method="post" action="<?= PROTOCOLO ?>://<?= PATH ?>/accounts/validarCadastro">
                <div class="row">
                    <div class="col-12">
                ...
                <div class="form-group">
                    <button class="btn btn-primary btn-lg btn-submit" id=cadastrar">Cadastrar</button>
                </div>
